...
cxx_args = ['-std=c++17',"-O3"] # test on cuda 12.1 + pytorch 2.3
nvcc_args = [
	'-D__CUDA_NO_HALF_OPERATORS__',
    '-gencode', 'arch=compute_60,code=sm_60', # change according to https://arnon.dk/matching-sm-architectures-arch-and-gencode-for-various-nvidia-cards/
